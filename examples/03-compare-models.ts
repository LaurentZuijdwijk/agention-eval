...
const dataset = new EvalDataset([
  { input: 'MacBook Pro 14" — $1,999.00',          expected: { product: 'MacBook Pro 14"', price: 1999 } },
  { input: 'Sony WH-1000XM5 headphones — £279.99', expected: { product: 'Sony WH-1000XM5 headphones', price: 279.99 } },
  { input: 'Kindle Paperwhite (16 GB) — €139,99',  expected: { product: 'Kindle Paperwhite (16 GB)', price: 139.99 } },
]);
